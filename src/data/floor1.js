  ...
  rooms: [
    {
      ...
      // Kept deliberately uncluttered — a hotel landing, not a furniture showroom: one seating
      // group, one console, two plants, plus the lift. The centre and the four doorway lanes
      // stay clear. `scale` enlarges each model to a believable size; `size` is its collision
      // footprint.
      furniture: [
        // The lift, on the north wall.
        { kind: 'lift', pos: [-2.6, -3.6], size: [1.8, 2.1, 0.36] },
        // South-west — the one seating group: a big sofa and a lounge chair around a glass
        // coffee table on a rug, with a floor lamp in the corner.
        ...
        // East wall — a single console with a table lamp, a plant beside it in the corner.
        ...
        // A single plant to balance the far corner.
