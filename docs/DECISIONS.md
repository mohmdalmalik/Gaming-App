...
- The floor currently has **9 rooms** (the owner asked for about 7–8): a short Service Passage was needed so that Storage and Service Room are both true dead ends off one route. Easy to change in data.
